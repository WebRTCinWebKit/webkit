...
macro(WEBKIT_OPTION_BEGIN)
    ...
    #OPTIONS FOR GOOGLE WEBRTC - BEGIN
    WEBKIT_OPTION_DEFINE(ENABLE_GOOGLE_WEBRTC "Toggle Google WebRtc Libraries in Webkit" PUBLIC ON)
    WEBKIT_OPTION_DEFINE(WEBRTC_POSIX "Google WEBRTC Option" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(ENABLE_EXTERNAL_AUTH "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(EXPAT_RELATIVE_PATH "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(FEATURE_ENABLE_SSL "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(GTEST_RELATIVE_PATH "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(HAVE_SRTP "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(HAVE_WEBRTC_VIDEO "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(HAVE_WEBRTC_VOICE "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(LIBPEERCONNECTION_LIB "GOOGLE DEFINE" PUBLIC 1)
    #WEBKIT_OPTION_DEFINE(LOGGING_INSIDE_WEBRTC "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(NO_MAIN_THREAD_WRAPPING "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(NO_SOUND_SYSTEM "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(SRTP_RELATIVE_PATH "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(USE_WEBRTC_DEV_BRANCH "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(WEBRTC_CHROMIUM_BUILD "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(V8_DEPRECATION_WARNINGS "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(SSL_USE_NSS "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(HAVE_NSS_SSL_H "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(SSL_USE_NSS_RNG "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(LINUX "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(WEBRTC_LINUX "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(CHROMIUM_BUILD "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(CR_CLANG_REVISION "GOOGLE DEFINE" PUBLIC 233105-2)
    #WEBKIT_OPTION_DEFINE(COMPONENT_BUILD "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(USE_LIBJPEG_TURBO "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(USE_X11 "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(ENABLE_WEBRTC "GOOGLE DEFINE" PUBLIC ON)
    #WEBKIT_OPTION_DEFINE(DCHECK_ALWAYS_ON "GOOGLE DEFINE" PUBLIC ON)
    #OPTIONS FOR GOOGLE WEBRTC - END
endmacro()
